...
public class CompactVenue implements FoursquareEntity {
  ...
  /**
   * Returns specials at this venue
   * @return specials at this venue
   */
  ...
  /**
   * Returns canonical URL for this venue.
   * 
   * @return canonical URL for this venue
   */
  ...
  /**
   * Returns the venue's rating 0.0-10.0
   * @return
   */
  ...
  /* Moved from CompleteVenue since seeing in compact results */
