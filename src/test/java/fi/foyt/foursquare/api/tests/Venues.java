...
public class Venues {
  ...
  public final void testVenuesTips() throws FoursquareApiException {
    ...
    assertEquals("https://playfoursquare.s3.amazonaws.com/pix/APSJTPELZ5LGL0AYHGKVQEECS5QSXGCQYULHAXBLR5ZTDNS2.jpg", result.getResult().getItems()[10].getPhoto().getUrlOriginal());
  }
  ...
  public final void testVenuesPhotos() throws FoursquareApiException {
    ...
    assertEquals("https://playfoursquare.s3.amazonaws.com/pix/ELYWFCR5XDLEKDHDCVBCIZZJFJREEQQPOF4B0Z2MPQ433HSN.jpg", result.getResult().getItems()[0].getUrlOriginal());
    assertEquals(new Integer(720), result.getResult().getItems()[0].getHeight());
    assertEquals(new Integer(537), result.getResult().getItems()[0].getWidth());
